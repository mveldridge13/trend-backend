...
export class CurrencyService {
  private readonly currencyMap = new Map<string, CurrencyInfo>([
  ...
  private readonly timezoneToCountryMap = new Map<string, string>([
    ['Australia/Sydney', 'AU'],
  ...
  private getDefaultCurrency(): CurrencyInfo {
