...
const hierarchicalCategories = [
  ...
  },
  {
    ...
    isMain: true,
    subcategories: [
      { name: "Clothing", description: "Clothes, shoes, accessories", type: "EXPENSE", icon: "shirt-outline", color: "#95E1D3" },
      { name: "Electronics", description: "Gadgets, tech accessories", type: "EXPENSE", icon: "phone-portrait-outline", color: "#95E1D3" },
      { name: "Home & Garden", description: "Furniture, decor, garden supplies", type: "EXPENSE", icon: "home-outline", color: "#95E1D3" },
      { name: "Personal Care", description: "Toiletries, cosmetics", type: "EXPENSE", icon: "sparkles-outline", color: "#95E1D3" },
    ],
  },
  {
    name: "Entertainment",
    ...
    isMain: true,
    subcategories: [
      { name: "Movies & Shows", description: "Cinema, streaming services", type: "EXPENSE", icon: "film-outline", color: "#F38181" },
      { name: "Music", description: "Concerts, music streaming", type: "EXPENSE", icon: "musical-notes-outline", color: "#F38181" },
      { name: "Games", description: "Video games, board games", type: "EXPENSE", icon: "game-controller-outline", color: "#F38181" },
      { name: "Sports & Fitness", description: "Gym, sports activities", type: "EXPENSE", icon: "fitness-outline", color: "#F38181" },
    ],
  },
  {
  ...
  },
  {
    ...
    isMain: true,
    subcategories: [
      { name: "Courses", description: "Online courses, workshops", type: "EXPENSE", icon: "school-outline", color: "#FFFFD2" },
      { name: "Books", description: "Books, e-books", type: "EXPENSE", icon: "book-outline", color: "#FFFFD2" },
      { name: "Tuition", description: "School, university fees", type: "EXPENSE", icon: "library-outline", color: "#FFFFD2" },
    ],
  },
  {
    name: "Income",
