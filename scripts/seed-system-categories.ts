...
const hierarchicalCategories = [
  ...
  // 3. BILLS (Main Category) - UPDATED SUBCATEGORIES
  {
    ...
    subcategories: [
      ...
      {
        name: "Electricity",
        description: "Electricity and power utilities",
        type: CategoryType.EXPENSE,
        icon: "flash-outline",
        color: "#45B7D1",
      },
  ...
  // 4. HEALTH (Main Category)
  {
    ...
    subcategories: [
      ...
      {
        name: "Dental",
        description: "Dental care, orthodontics, cleanings",
        type: CategoryType.EXPENSE,
        icon: "happy-outline",
        color: "#96CEB4",
      },
      {
        ...
        description: "Health insurance premiums and coverage",
        type: CategoryType.EXPENSE,
      ...
      {
        name: "Prescription",
        description: "Prescription medications and pharmacy",
        type: CategoryType.EXPENSE,
      ...
      {
        name: "Veterinary",
        description: "Pet health, vet visits, pet medications",
        type: CategoryType.EXPENSE,
        icon: "paw-outline",
        color: "#96CEB4",
      },
      {
        name: "Medical",
        description: "Doctor visits, medical consultations, treatments",
        type: CategoryType.EXPENSE,
        icon: "heart-outline",
        color: "#96CEB4",
      },
